...
export default function FarmerSchemesPortal() {
  ...
  const schemesData = [
    {
      ...
      description:
        "Direct income support of ₹6000 per year in three installments to all landholding farmers",
      benefit: "₹6,000/year",
    ...
    },
    {
      ...
      description:
        "Provides adequate and timely credit for agricultural needs with low interest rates",
    ...
    },
    {
      ...
      description:
        "Crop insurance scheme providing coverage against crop loss due to natural calamities",
    ...
    },
    {
      ...
      description:
        "Provides soil health cards to farmers with recommendations on nutrients and fertilizers",
    ...
    },
    {
      ...
      description:
        "Water-efficient irrigation technology that saves up to 60% water and increases yield by 40-50%",
    ...
    },
    {
      ...
      description:
        "Solar-powered irrigation pumps with 90% subsidy reducing electricity costs",
    ...
    },
    {
      ...
      description:
        "Agricultural drones for pesticide spraying, reducing labor cost and increasing efficiency",
    ...
    },
    {
      ...
      description:
        "On-spot soil testing facility providing immediate results and fertilizer recommendations",
    ...
    },
    {
      ...
      description:
        "Online trading platform for agricultural commodities ensuring better price discovery",
    ...
    },
    {
      ...
      description:
        "Promotes organic farming with financial assistance of ₹50,000 per hectare over 3 years",
    ...
    },
    {
      ...
      description:
        "GPS and sensor-based farming tools for optimal resource utilization and yield management",
    ...
    },
    {
      ...
      description:
        "Special trains for quick transportation of perishable agricultural products",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-yellow-50 p-4 md:p-8 h-full overflow-y-scroll no-scrollbar">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-700 text-lg md:text-xl font-medium">
            Farmer Schemes & Technologies
          </p>
          <p className="text-sm text-gray-600 mt-2">
            Empowering farmers with subsidies, schemes, and modern technologies
          </p>
        </div>
        ...
        {filteredData.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredData.map((item) => (
              ...
              >
                {/* Category Badge */}
                <div
                  className={`px-4 py-2 flex items-center gap-2 ${getCategoryColor(
                    item.category
                  )}`}
                >
          ...
          <div className="text-center py-16">
            <p className="text-gray-500 text-lg">
              No schemes or technologies found matching your search
            </p>
          </div>
        )}
        ...
        <div className="mt-12 bg-white rounded-xl shadow-md p-6 text-center">
          <p className="text-sm text-gray-700 mb-2">
            <strong>Need Help?</strong> Contact your nearest agriculture office
            or call toll-free
          </p>
          <p className="text-2xl font-bold text-green-700">1800-180-1551</p>
          <p className="text-xs text-gray-500 mt-4">
            * Information is for guidance only. Please verify details with
            respective departments before applying.
          </p>
        </div>
      </div>
    </div>
